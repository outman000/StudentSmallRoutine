...
namespace SmallRoutineFile
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            //};
            //   options.Configuration = Configuration.GetConnectionString("RedisConnectionStrings");
            //});



            var csredis = new CSRedis.CSRedisClient(Configuration.GetConnectionString("RedisConnectionStrings"));
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                var xmlPath = Path.Combine(basePath, "SmallRoutineFile.xml");
